...
2) median values of temperature, wind speed, and atmospheric pressure by state station
```{r station-medians}
# medians by stations (keep state)
station_med <- met[, .(
...
# bs = "cr" cubic regression line, 20 degree of freedom
